...
import { PhaseIcon } from './adw-monitor-card/PhaseIcon';
import { formatCost, formatDuration, getPhaseStatus, workflowPhases } from './adw-monitor-card/utils';
                          ...
                          <div className="flex flex-col items-center">
                            <div className={`relative w-14 h-14 rounded-full flex items-center justify-center transition-all duration-500 ${
                              ...
                              <div className="relative z-10">
                                <PhaseIcon iconName={phase.icon} status={status} />
                              </div>
                            </div>
